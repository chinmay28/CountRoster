...
- **"You"** (or **"Your"**) means the individual or legal entity that submits a
  ...
  with that entity are considered a single Contributor.
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, that is intentionally submitted
  by You to the Project for inclusion in, or documentation of, any of the
  products owned or managed by the Project. "Submitted" means any form of
  ...
  control systems and issue tracking systems managed by, or on behalf of, the
...
it was submitted. If any entity institutes patent litigation against You or any
...
4. Your Contribution does not knowingly include any third-party material that is
   subject to license terms incompatible with this Agreement, and where it does
   include third-party material, You have identified the source and license of
   that material in Your Contribution.
...
This CLA is adapted from the Apache Software Foundation Individual Contributor
License Agreement and common dual-licensing CLA practice. It is provided as a
starting point and is not legal advice; consult a lawyer before relying on it
